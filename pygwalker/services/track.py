...
def track_event(event: str, properties: Optional[Dict[str, Any]] = None):
    ...
    PyGWalker will collect certain events data share which events about which feature is used in pygwalker, it only contains events tag about which feature you arrive for product optimization. No DATA YOU ANALYSIS IS SEND.
    ...
    - pygwalker's spec type: 'json', 'file', 'url'. We won't collect the exact value of spec. No DATA YOU ANALYSIS OR META OF THEM IS COLLECTED.
