...
build_dir = os.path.join(ROOT_DIR, "templates")
_component_func = components.declare_component("pygwalker_component", path=build_dir)


def pygwalker_component(props: Dict[str, Any], comm: BaseCommunication, key: str = "pygwalker"):
